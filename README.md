...
Qué ocurre cuando se ejecuta git push

Cuando el desarrollador ejecuta:

git push

Ocurre el siguiente proceso automático:

GitHub descarga el código
...
Se genera el archivo .jar

Se prepara la imagen Docker

Este proceso automatizado es lo que se conoce como CI/CD.
